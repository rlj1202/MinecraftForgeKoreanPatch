        ...
        else
        {
            switch (keyCode)
            {
                case 14:
                    ...
                    {
                    	Result r = KoreanCore.deleteKorean(getText(), getCursorPosition(), getSelectionEnd());// XXX
                    	setText(r.STR);
                    	setCursorPosition(r.CURSOR);
//                        this.deleteFromCursor(-1);
                ...
                default:
                    ...
                    if (ChatAllowedCharacters.isAllowedCharacter(typedChar))
                    {
                        if (this.isEnabled)
                        {
                        	Result r = KoreanCore.writeKorean(getText(), getCursorPosition(), getSelectionEnd(), typedChar);// XXX
                        	this.setText(r.STR);
                        	this.setCursorPosition(r.CURSOR);
                        	this.setSelectionPos(r.SELECTION);
